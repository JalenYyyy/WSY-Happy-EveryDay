...
const cats = [
  {
    ...
    backstory: "耐耐是一只喜欢晒太阳的奶油色猫咪，记得家里每个人的心情变化。",
  },
  {
    name: "咪仔",
    ...
    backstory: "咪仔总是占着沙发最舒服的位置，却会在深夜悄悄靠近需要陪伴的人。",
  },
  {
    name: "布丁",
    ...
    backstory: "布丁喜欢追光点和纸团，是家里最会制造快乐的小猫。",
  },
  {
    name: "丢丢",
    ...
    tone: "慢节奏、留白多、稳定可靠。",
    backstory: "丢丢喜欢窗边和雨声，最擅长陪人度过疲惫的夜晚。",
  },
  {
    name: "希乐乐",
    ...
    backstory: "希乐乐是一只像小军师一样的猫，喜欢把复杂问题理成三步。",
  },
];
